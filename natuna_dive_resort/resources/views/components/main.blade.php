<main>
    ...
    <section class="about">
        <div class="main-about">
            <img src="img/natuna-dive-resort-2.jpg" alt="">
        ...
        <div class="main-content">
            <section class="package" id="package">
                ...
                <div class="col-package">
                    ...
                    <div class="card">
                        <div class="body-card">
                            <div class="card-title">Scuba and Diving</div>
                            <div class="card-text">
                                <p>Dive and Stay at Natuna Dive Resort for 3 day 2 Night in a double or Twin Share Luxury room</p>
                            </div>
